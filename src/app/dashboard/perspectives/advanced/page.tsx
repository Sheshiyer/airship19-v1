...
export default function AdvancedPerspectivesPage() {
  ...
  const advancedPerspectives = perspectives.filter(p => p.type === 'Advanced')
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-white">Advanced Perspectives</h1>
          <div className="text-sm text-neutral-400">
            Unlock enhanced abilities and deeper insights
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading ? (
            ...
            advancedPerspectives.map((animal) => (
              <motion.div
                key={animal.name}
              ...
              >
                <div className="aspect-square rounded-lg bg-gradient-to-br from-purple-500/20 to-pink-500/20 mb-4 overflow-hidden">
                  {animal.unlocked ? (
                    <Image
                ...
                {animal.unlocked && (
                  <div className="absolute inset-x-4 bottom-4">
                    <button
                      ...
                      className="w-full py-2 rounded-lg bg-purple-500/20 text-purple-400 hover:bg-purple-500/30 transition-colors text-sm font-medium"
                    >
            ...
            >
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-purple-400">Advanced Perspective</p>
                </div>
                <button
                  onClick={() => setSelectedAnimal(null)}
              ...
              <div className="aspect-video rounded-lg bg-gradient-to-br from-purple-500/20 to-pink-500/20 mb-6 overflow-hidden">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Advanced Abilities</h3>
                  <ul className="space-y-2">
                    {selectedAnimal.name === 'Wolf' && (
                      <>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Advanced pack leadership protocols
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Enhanced digital territory control
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Strategic network hunting capabilities
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Pack synchronization mastery
                        </li>
                      </>
                    )}
                    {selectedAnimal.name === 'Rabbit' && (
                      <>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Advanced digital agility systems
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                        ...
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Sophisticated evasion protocols
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Network adaptation mastery
                        </li>
                      </>
                    )}
                    {selectedAnimal.name === 'Wisp' && (
                      <>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Advanced ethereal manifestation
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Enhanced energy field control
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Digital realm phase shifting
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                    ...
                    {selectedAnimal.name === 'Pilot' && (
                      <>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Advanced aerial command systems
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                          Enhanced strategic deployment
                        </li>
                        <li className="flex items-center gap-2 text-neutral-300">
                          <span className="w-2 h-2 rounded-full bg-purple-500" />
                ...
                <div className="pt-4 border-t border-white/10">
                  {selectedAnimal.unlocked ? (
                    <button 
                      ...
                      className="w-full py-3 rounded-lg bg-purple-500 text-white hover:bg-purple-600 transition-colors font-medium"
                    >
                      Activate Perspective
                    </button>
                  ) : (
                    <a
                      ...
                      className="block w-full py-3 rounded-lg bg-purple-500 text-white hover:bg-purple-600 transition-colors font-medium text-center"
                    >
                      Purchase on NFTify
                    </a>
                  )}
